...
<script>
	...
	import {
		apiBusinessInformationInfoinformationId_Get,apiBusinessInformationPage_Post
	} from '@/API/乡村名片资讯.js';
	import {
		apiBusinessInformationTagTagLabel_Get,apiBusinessInformationTagInfoinfoTagId_Get
	} from '@/API/资讯标签.js'; //标签
	...
	export default {
		...
		data() {
			return {
				bannerimg: [],
				listStyle: [{
						imgUrl: [imgBaseUrl + 'tagNewsStyle03.jpg'],
						title: '默认风格',
						tag:['必须有图通用型'],
						name:'list_1'
					},
					{
						imgUrl: [imgBaseUrl + 'tagNewsStyle02.jpg'],
						title: '图文展示',
						tag:['必须有图'],
						name:'list_2'
					},
					{
						imgUrl: [imgBaseUrl + 'tagNewsStyle01.jpg'],
						title: '联动展示',
						tag:['必须有图'],
						name:'list_3'
					},
